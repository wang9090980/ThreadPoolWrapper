...
public class ThreadPoolInfo implements Serializable, Cloneable {
    ...
    public static class ThreadBuilder {
        ...
        public ThreadBuilder setCoreSize(int coreSize) {
            this.coreSize = coreSize;
            return this;
        }

        public ThreadBuilder setMaxSize(int maxSize) {
            this.maxSize = maxSize;
            return this;
        }
         ...
         * @return
         */
        public ThreadBuilder setThreadKeepAliveTime(long threadKeepAliveTime) {
            this.threadKeepAliveTime = threadKeepAliveTime;
            return this;
        }

        public ThreadBuilder setQueueSize(int queueSize) {
            this.queueSize = queueSize;
            return this;
        }
        ...
        public ThreadPoolInfo build() {
            return new ThreadPoolInfo(name, coreSize, maxSize, threadKeepAliveTime, queueSize);
        }

        public Map<String, ThreadPoolInfo> buildMap() {
            Map<String, ThreadPoolInfo> map = new HashMap<>();
            map.put(name, new ThreadPoolInfo(name, coreSize, maxSize, threadKeepAliveTime, queueSize));
